...
package webTest;
 ...
 public class ComprarPassagemWD {
    ...
    //2.2 Funções e Métodos
      ...
      // Antes do Teste
     @BeforeEach
     public void setUp(){ //inicio da classe
         //  declarar o gerencimento para baixar o chome driver
     ...
     @AfterEach
     // Depois do Teste
     public void tearDown() {  //inici do After
         driver.quit(); //destroi a intancia do Selenuim WebDriver
     }  //fim do After
